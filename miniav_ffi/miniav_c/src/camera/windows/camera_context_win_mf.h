...
// Initializes the Windows Media Foundation specific parts of the camera context.
// This function will set ctx->ops = &g_camera_ops_win_mf;
// and then call g_camera_ops_win_mf.init_platform(ctx);
