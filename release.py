"""
Release Management Script for miniav Package Family

This script manages version updates and changelog entries across all packages in the miniav repository.
...
2. ADD CHANGELOG MESSAGES:
   ...
   - python release.py change "created abc functionality" miniav_ffi
     → Adds message only to miniav_ffi changelog current version
   
   - python release.py change "updated API" miniav_ffi,miniav
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Manage versioning, changelogs, and publishing for miniav packages.",
