"""
Release Management Script for miniav_tools Package Family

This script manages version updates and changelog entries across all packages in the miniav_tools repository.
Mirrors the script used by the minigpu and miniAV repositories.
...
# Order matters: platform_interface first (depended on by all backends),
# then the facade, then backends, then higher-level packages.
PACKAGES = [
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Manage versioning, changelogs, and publishing for miniav_tools packages.",
